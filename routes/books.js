...
router.get('/', booksController.books_view_all_Page);

// POST request for creating a new book
router.post('/', booksController.books_create_post);

// DELETE request for deleting a book
router.delete('/:id/delete', booksController.books_delete);

// PUT request for updating a book
router.put('/:id/update', booksController.books_update_put);
